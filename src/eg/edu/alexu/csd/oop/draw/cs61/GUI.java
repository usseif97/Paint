	...
	public GUI(Factory factory) {
		...
		saveAction.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				//drawingEngine.save("C:\\Users\\pc\\Desktop\\save.XML");
				//System.out.println("SAAAAAAAAAAAave");
				drawingEngine.save("C:\\Users\\pc\\Desktop\\save.JSON");
		...
		loadAction.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				drawingEngine.load("C:\\Users\\pc\\Desktop\\save.XML");
				//System.out.println("SAAAAAAAAAAAave");
				//drawingEngine.load("C:\\Users\\pc\\Desktop\\save.JSON");
		...
		myGraphics.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
		        ...
		        Point pp = e.getPoint();
				//Shape[] sArr = myGraphics.getShapes();
		        ...
		        /*for (int i = 0; i < sArr.length; i++) {
                	Shape ss = (Shape) sArr[i].getProperties().;
                    if (((Component) sArr[i]).contains(pp)) {  //check if mouse is clicked within shape

                        //we can either just print out the object class name
                        System.out.println("Clicked a "+sArr[i].getClass().getName());*/

                        //or check the shape class we are dealing with using instance of with nested if
                       //if (ss instanceof Rectangle2D) {
                       //     System.out.println("Clicked a rectangle");
                       // } else if (ss instanceof Ellipse2D) {
